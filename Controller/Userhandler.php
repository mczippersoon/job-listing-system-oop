...
class Userhandler
{
    ...
    public function createUser($username, $email, $password, $role)
    {
        ...
        // Set default profile picture filename (NOT full path)
        $defaultProfile = 'default.jpg'; // Just the filename

        $stmt = $this->conn->prepare("INSERT INTO users (username, email, password, role, profile_picture) 
